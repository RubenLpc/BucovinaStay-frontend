...
const OFFICIAL = {
  ...
  rarauGiumalauHarta:
    "https://judetulsuceava.ro/descopera/harti/harta-traseelor-turistice-montane-din-masivul-rarau-giumalau-si-zona-nordica-a-muntilor-bistritei/",
  calimaniHartaSuceava:
    "https://judetulsuceava.ro/descopera/harti/harta-traseelor-turistice-montane-din-parcul-national-calimani/",
...
// Seed editorial: păstrăm doar denumiri/surse reale; câmpurile neconfirmate rămân goale.
...
const trailsData = [
  ...
  {
    id: "sv-14b",
    name: "Sat Rusca – Valea Rusca – Cabana Giumalău",
    area: "Rusca / Giumalău",
    difficulty: "Mediu",
    durationHrs: null,
    distanceKm: null,
    season: "",
    tags: ["forest", "nature"],
    image: imgSeed("rusca-valea-rusca-giumalau"),
    url: OFFICIAL.rarauGiumalauHarta,
    officialLinks: linksDefault([
      { label: "Harta oficială Rarău – Giumalău", url: OFFICIAL.rarauGiumalauHarta },
    ]),
  },

  {
    id: "sv-14c",
    name: "Sat Rusca – Piciorul Ruscăi – Cabana Giumalău",
    area: "Rusca / Giumalău",
    difficulty: "Mediu",
    durationHrs: null,
    distanceKm: null,
    season: "",
    tags: ["forest", "ridge"],
    image: imgSeed("rusca-piciorul-ruscai-giumalau"),
    url: OFFICIAL.rarauGiumalauHarta,
    officialLinks: linksDefault([
      { label: "Harta oficială Rarău – Giumalău", url: OFFICIAL.rarauGiumalauHarta },
    ]),
  ...
  {
    id: "sv-18b",
    name: "Vatra Dornei – Dealul Drăncani – Poiana Țicșeni – Poiana Ciungi – Vârful Giumalău",
    area: "Vatra Dornei / Giumalău",
    difficulty: "Greu",
    durationHrs: null,
    distanceKm: null,
    season: "",
    tags: ["ridge", "view", "nature"],
    image: imgSeed("vatra-dornei-drancani-giumalau"),
    url: OFFICIAL.rarauGiumalauHarta,
    officialLinks: linksDefault([
      { label: "Harta oficială Rarău – Giumalău", url: OFFICIAL.rarauGiumalauHarta },
    ]),
...

  {
    ...
    officialLinks: linksDefault([
      ...
      { label: "Harta oficială Călimani (Județul Suceava)", url: OFFICIAL.calimaniHartaSuceava },
    ]),
  },
  ...
  {
    id: "sv-24b",
    name: "Gura Haitii – Sat Dornișoara",
    area: "Gura Haitii / Dornișoara",
    difficulty: "Greu",
    durationHrs: null,
    distanceKm: null,
    season: "",
    tags: ["ridge", "nature", "long"],
    image: imgSeed("gura-haitii-dornisoara"),
    url: OFFICIAL.calimaniHartaSuceava,
    officialLinks: linksDefault([
      { label: "Harta oficială Călimani (Județul Suceava)", url: OFFICIAL.calimaniHartaSuceava },
      { label: "Călimani – Hartă (oficial)", url: OFFICIAL.calimaniHarta },
    ]),
  ...
  {
    id: "sv-27b",
    name: "Sat Dornișoara – Coada Pietrosului",
    area: "Dornișoara / Călimani",
    difficulty: "Mediu",
    durationHrs: null,
    distanceKm: null,
    season: "",
    tags: ["forest", "nature"],
    image: imgSeed("dornisoara-coada-pietrosului"),
    url: OFFICIAL.calimaniHartaSuceava,
    officialLinks: linksDefault([
      { label: "Harta oficială Călimani (Județul Suceava)", url: OFFICIAL.calimaniHartaSuceava },
      { label: "Călimani – Hartă (oficial)", url: OFFICIAL.calimaniHarta },
  ...
  {
    id: "sv-27c",
    name: "Sat Dornișoara – Sat Răstolița",
    area: "Dornișoara / Răstolița",
    difficulty: "Greu",
    durationHrs: null,
    distanceKm: null,
    season: "",
    tags: ["forest", "long", "nature"],
    image: imgSeed("dornisoara-rastolita"),
    url: OFFICIAL.calimaniHartaSuceava,
    officialLinks: linksDefault([
      { label: "Harta oficială Călimani (Județul Suceava)", url: OFFICIAL.calimaniHartaSuceava },
      { label: "Călimani – Hartă (oficial)", url: OFFICIAL.calimaniHarta },
